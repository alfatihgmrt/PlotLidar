        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    import serial
                    import time
                    serial_port = '/dev/ttyACM0'  # Serial port for UART on Jetson (TX pin: pin$baud_rate = 9600  # Baud rate must match between both devices
                    # Open serial port
                    baud_rate = 9600
                    ...
                    fov_h = 120
                    res_h, res_v = 1920, 1080
                    angle_x = (x_err/res_h)*fov_h

                    if cls == 1 and conf >= 0.88 and -x_tol_err_pos < x_err < x_tol_err_pos:
